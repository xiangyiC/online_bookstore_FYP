                        ...
                        <ul class="cards">
                            ...
                            <div class="card_">
                                <div class="card_image">
                                    <img src="{{asset('images/')}}/{{$category->book_image}}">
                                </div>
                                    <div class="card_content">
                                        <h2 class="card_title">{{$category->book_title}}</h2>
                                        <hr>
                                        
                                        <i><p class="card-text author">Publisher: {{$category->book_publisher}}</p></i>
                                        <p class="card-text price">RM{{number_format($category->book_price, 2)}}</p>
