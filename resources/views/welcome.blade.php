...
@else
<h3 class="mb-3 mx-5">NEW ARRIVALS</h3>
<p class="mx-5">No added book</p>
@endif
@if(session()->get('book_count')>0)
<!--Book carousel-->
                ...
                <div class="col-lg-2 col-md-3 mb-3 col-sm-12">
                  <div class="card">
                    ...
                    <div class="title" style="height: 60px;">
                      ...
                      <div class="author">
                        <i style="font-size:0.8em">{{$stationery->stationery_publisher}}</i>
                      </div>
...
@else
<h3 class="mb-3 mx-5">STATIONERIES</h3>
<p class="mx-5">No added stationery</p>
@endif
...
<!-- category logo -->
<div class="container-fluid mx-auto category" style="text-align: center;">
  <div class="row justify-content-center">
    <div class="col-md-2 col-xs-3 col-sm-3">
      <a href="{{route('fiction')}}"><img src="{{asset('images/fiction.png')}}" alt="" class="icon img-fluid" style=""></a><br>
      <p class="icontext">FICTION</p>
    </div>
    <div class="col-md-2 col-xs-3 col-sm-3" >
      <a href="{{route('nonfiction')}}"><img src="{{asset('images/nonfiction.png')}}" alt="" class="icon img-fluid" style=""></a><br>
      <p class="icontext">NON-FICTION</p>
    </div>
    <div class="col-md-2 col-xs-3 col-sm-3">
      <a href="{{route('children')}}"><img src="{{asset('images/children.png')}}" class="icon img-fluid"style=""></a><br>
      <p class="icontext">CHILDREN BOOKS</p>
    </div>
    <div class="col-md-2 col-xs-3 col-sm-3">
      <a href="{{route('stationery')}}"><img src="{{asset('images/stationery.png')}}" class="icon img-fluid"style=""></a><br>
